# -*- coding: utf-8 -*-
#
# PewPew documentation build configuration file, created by
...
# ones.
extensions = ['sphinx.ext.intersphinx', 'sphinx.ext.viewcode', 'alabaster']
...
man_pages = [
    (master_doc, 'pewpew', u'PewPew Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PewPew', u'PewPew Documentation',
     author, 'PewPew', 'PewPew FeatherWing Documentation.',
     'Miscellaneous'),
]
